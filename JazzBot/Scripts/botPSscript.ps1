...
while ($true)
{
    $process = Start-Process -FilePath "C:\Program Files\dotnet\dotnet.exe" -ArgumentList $BotDllPath -PassThru -WorkingDirectory $BotDllDir -Wait
